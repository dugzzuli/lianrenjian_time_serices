...
if 1==1
    for j=1:3
        ...
        for i=1:26
            ...
            DataWind26(:,:,:,i)=reshape(WindOriData,24,7,2);
        end
...
if 1==0
    ...
    data_all=zeros(12,10,2,20);
    for i=1:20
        data_mesa=pol_mesa(41:280,i);
        
        data_reshape_norm_mesa=reshape(data_mesa,12,10,2);
...
if 1==0
    ...
    data_all_rel=zeros(12,4,4,26);
    sensor_count=0;
    for sensor=1:50:1326.
        sensor_count=sensor_count+1;
        data_wind=wind_nrel(:,sensor);
        data_reshape_norm_temp=reshape(data_wind,12,4,4);
...
if 1==0
    ...
    for sensor=1:30:900
        ...
        data_reshape_temp_ori=reshape(data_temp,12,4,3);
