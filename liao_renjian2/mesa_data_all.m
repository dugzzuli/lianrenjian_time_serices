...
data_all=zeros(12,11,2,20);
for i=1:20
    data_mesa=pol_mesa(17:280,i);
    data_norm_mesa=NormLiza(data_mesa,'mm');%标准化数据
    data_reshape_norm_mesa=reshape(data_norm_mesa,12,11,2);
...
for rank=1:20
    for count=1:2
        ...
        oriData=data_test_reshape_norm_mesa(:,11,2,:);
        data_test_reshape_norm_mesa(:,11,2,:)=0;
